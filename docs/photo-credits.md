...
確認日：2026-09-17。本文は公式資料から独自に要約し、創建伝承と歴史上の出来事を区別しています。Wikipediaの文章は転載していません。

## 写真

Wikimedia Commonsの各ファイルのメタデータで作者・ライセンス・対象地を確認し、Commonsが生成した960px幅のJPEGをローカル同梱しました。画面ではobject-fitで枠に合わせてトリミングします。写真のライセンスは写真自体に適用されます。作者がアプリを推奨する意味ではありません。
...
極楽寺の写真とその表示用トリミングはCC BY-SA 3.0で提供します。詳細画面に撮影者・原ファイル・ライセンス・撮影日・表示上のトリミングを記載しています。カードとホームの写真にも撮影者とライセンスを表示し、詳細から原典へ進めます。

撮影時の写真で、現在の景観を保証するものではありません。岡山神社の写真は2024年の随神門修理前です。写真が読み込めない場合は「実景ではない」ことをaltに示したイラストへ切り替えます。

## 写真未掲載

岡山市北区番町の伊勢神社は、今回のCommons・Wikipedia・公式資料の調査では再利用可能な実景写真を確認できませんでした。同名の鹿児島県の伊勢神社の写真は別施設のため使用していません。架空20寺社も、実在写真をその寺社のものとして表示しません。伊勢神社と架空寺社は、アプリ独自のイメージイラストを明示して表示します。
...
各ページに出典と確認日を表示します。ご利益は信仰・伝承の紹介で、結果を保証する表現は使用していません。


## 船岡大祭の掲載写真・情報（2026-09-18追加）

- 写真：`public/events/kenkun.jpg`。Yanajin33撮影、2012-08-13。[原ファイル：Takeisao-jinja Honden.jpg](https://commons.wikimedia.org/wiki/File:Takeisao-jinja_Honden.jpg)。[CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/)。Commons生成の1280px幅JPEGを同梱。画像と表示用トリミングを同じCC BY-SA 3.0で提供します。
- 写真は建勲神社の社殿・玉垣の実景であり、2026年の船岡大祭や当日の奉納を撮影した写真ではありません。作者によるアプリやイベントの推薦を意味しません。
- 日程・会場：[京都府観光連盟「船岡大祭」](https://www.kyoto-kankou.or.jp/event/779)。2026年10月19日（月）、11時。所在地、バス停から徒歩約9分を確認。
- 由来・恒例の奉納：[建勲神社「祭典・行事」](https://kenkun-jinja.org/ritual/)。祭典の由来は公式の「建勲」の神号が宣下された日に合わせて要約。仕舞『敦盛』・舞楽は恒例行事として紹介し、2026年の詳細プログラムを確定情報として掲載していません。
- 駐車場：[建勲神社「アクセス」](https://kenkun-jinja.org/access/)。無料という料金情報と206系統の案内は利用者提供の掲載内容に基づきます。特別行事や最新のアクセスは公式に確認する表示です。
- 道幸先生のおすすめ欄は配置・編集のデモです。本人による当該イベントへの推薦を確認したという主張ではありません。
